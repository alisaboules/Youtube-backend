...
import { TOXXED_VIDEOS } from './toxxed.videos.data'
import { ZARAK_VIDEOS } from './zarak.videos.data'
import { GRANDALMILLIA_VIDEOS } from './grandalmillia.videos.data' 
...
export const VIDEOS = [
	...
	},
	{
		...
		isPublic: true,
		tags: ['cyberpunk', 'bladerunner', 'city', 'night', 'synthwave', '12hours'],
